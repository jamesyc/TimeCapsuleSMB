...
_POLICIES: dict[tuple[str, str], StagePolicy] = {
    ...
    ("update-check", "resolve_paths"): StagePolicy(LOCAL_READ, True, "Resolve update check cache paths."),
    ("update-check", "check_version"): StagePolicy(LOCAL_READ, True, "Fetch or read version metadata."),
    ("update-check", "fetch_release"): StagePolicy(LOCAL_READ, True, "Fetch or read GitHub release metadata."),
    ...
    ("deploy", "check_flash_capacity"): StagePolicy(REMOTE_READ, True, "Check free Flash space after removing old software."),
    ("deploy", "pre_upload_actions"): StagePolicy(REMOTE_WRITE, False, "Stop managed processes and remove replaceable software."),
    ...
    ("deploy", "post_upload_actions"): StagePolicy(REMOTE_WRITE, False, "Apply payload permissions."),
