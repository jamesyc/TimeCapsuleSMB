...
_POLICIES: dict[tuple[str, str], StagePolicy] = {
    ...
    ("deploy", "netbsd4_activation"): StagePolicy(REMOTE_WRITE, False, "Start the deployed NetBSD4 runtime."),
    ("deploy", "probe_runtime"): StagePolicy(REMOTE_READ, True, "Check whether the deployed runtime is already ready."),
    ...
    ("activate", "probe_runtime"): StagePolicy(REMOTE_READ, True, "Check whether the NetBSD4 runtime is already ready."),
