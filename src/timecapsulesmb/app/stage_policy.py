...
_POLICIES: dict[tuple[str, str], StagePolicy] = {
    ...
    ("deploy", "preflight_flash_capacity"): StagePolicy(REMOTE_READ, True, "Check available Flash space for the discovery update."),
    ...
    ("deploy", "cleanup_legacy_flash_discovery"): StagePolicy(REMOTE_WRITE, False, "Remove the replaced legacy Flash discovery binary."),
    ("deploy", "flush_legacy_flash_cleanup"): StagePolicy(REMOTE_WRITE, False, "Flush legacy Flash cleanup writes."),
