...
_POLICIES: dict[tuple[str, str], StagePolicy] = {
    ...
    ("deploy", "check_xattr_migration"): StagePolicy(REMOTE_READ, True, "Check the explicit xattr migration prerequisite."),
    ("deploy", "migration_preflight"): StagePolicy(REMOTE_READ, True, "Validate explicit migration state and matching tooling."),
    ("deploy", "migration_select_volumes"): StagePolicy(REMOTE_READ, True, "Select attached HFS volumes for explicit migration."),
    ("deploy", "migration_mount_volumes"): StagePolicy(REMOTE_WRITE, True, "Ask diskd to mount selected HFS volumes."),
    ("deploy", "migration_start"): StagePolicy(DESTRUCTIVE, False, "Disable legacy startup and begin offline metadata conversion."),
    ("deploy", "migration_follow"): StagePolicy(REMOTE_READ, True, "Follow device-owned migration progress before deployment."),
    ...
    ("migrate-xattr", "load_config"): StagePolicy(LOCAL_READ, True, "Read xattr migration configuration."),
    ("migrate-xattr", "resolve_managed_target"): StagePolicy(REMOTE_READ, True, "Resolve and probe the migration target."),
    ("migrate-xattr", "migration_preflight"): StagePolicy(REMOTE_READ, True, "Validate the migration prerequisite and matching tooling."),
    ("migrate-xattr", "migration_select_volumes"): StagePolicy(REMOTE_READ, True, "Select attached HFS volumes for migration."),
    ("migrate-xattr", "migration_mount_volumes"): StagePolicy(REMOTE_WRITE, True, "Ask diskd to mount selected HFS volumes."),
    ("migrate-xattr", "migration_start"): StagePolicy(DESTRUCTIVE, False, "Disable legacy startup and begin offline metadata conversion."),
    ("migrate-xattr", "migration_follow"): StagePolicy(REMOTE_READ, True, "Follow live device-owned migration progress."),
    ("migrate-xattr", "migration_status"): StagePolicy(REMOTE_READ, True, "Read live or durable migration state."),
    ("migrate-xattr", "migration_cancel"): StagePolicy(DESTRUCTIVE, False, "Request migration cancellation at a safe file boundary."),
