...
_POLICIES: dict[tuple[str, str], StagePolicy] = {
    ...
    ("ssh-access", "load_config"): StagePolicy(LOCAL_READ, True, "Read selected device SSH access configuration."),
    ("ssh-access", "probe_ssh_access"): StagePolicy(REMOTE_READ, True, "Check selected device AirPort ACP and SSH ports."),
    ("ssh-access", "confirm_enable_ssh"): StagePolicy(REBOOT, True, "Confirm SSH enablement and reboot through AirPort ACP."),
    ("ssh-access", "acp_port_probe"): StagePolicy(REMOTE_READ, True, "Check AirPort ACP reachability before enabling SSH."),
    ("ssh-access", "acp_enable_ssh"): StagePolicy(REMOTE_WRITE, False, "Request SSH enablement through AirPort ACP."),
    ("ssh-access", "wait_for_ssh_enabled"): StagePolicy(REMOTE_READ, True, "Wait for SSH to open after ACP enablement."),
