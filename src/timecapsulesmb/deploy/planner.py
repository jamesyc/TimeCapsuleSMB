    ...
    *,
    ...
    return DeploymentPlan(
        ...
        pre_upload_actions=[
            ...
            stop_process_action("mdns-advertiser", force=True),
            stop_process_action("nbns-advertiser", force=True),
            remove_path_action(f"{payload_dir}/smb.conf.template"),
            remove_path_action(f"{private_dir}/adisk.uuid"),
            remove_path_action(f"{private_dir}/nbns.enabled"),
    ...
    *,
    ...
    return UninstallPlan(
        ...
        remote_actions=[
            ...
            stop_process_action("mdns-advertiser", force=True),
            stop_process_action("nbns-advertiser", force=True),
            *(remove_path_action(payload_dir) for payload_dir in payload_dirs),
            ...
            remove_path_action(flash_targets["tcapsulesmb.conf"]),
