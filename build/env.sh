...
SAMBA4_COMPAT_DIR="${SAMBA4_COMPAT_DIR:-$OUT/compat}"
SAMBA4_CROSS_EXEC_MODE="${SAMBA4_CROSS_EXEC_MODE:-live}"
SAMBA4_COMPAT_REPLAY_IN="${SAMBA4_COMPAT_REPLAY_IN:-}"
SAMBA4_COMPAT_REPLAY_OUT="${SAMBA4_COMPAT_REPLAY_OUT:-}"
...
export SAMBA4_COMPAT_DIR SAMBA4_CROSS_EXEC_MODE SAMBA4_COMPAT_REPLAY_IN SAMBA4_COMPAT_REPLAY_OUT
