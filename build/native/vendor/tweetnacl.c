/*
 * TweetNaCl 20140427, public-domain upstream source:
 * https://tweetnacl.cr.yp.to/20140427/tweetnacl.c
 *
 * TimeCapsuleSMB uses this only for SHA-512 and Ed25519 signature
 * verification so nbns-advertiser can authenticate downloaded heartbeat
 * binaries without linking the old device's unavailable OpenSSL libraries.
 */
#include "tweetnacl.h"
