...

{
    ...
    if [ "$BUILD_TARGET" = "netbsd7" ] && [ -f "$commands_magic" ]; then
    ...
    if [ "$BUILD_TARGET" = "netbsd7" ] && [ -f "$python_magic" ]; then
    ...
    if [ "$BUILD_TARGET" = "netbsd7" ] && [ -f "$windows_magic" ]; then
    ...
    if [ "$BUILD_TARGET" = "netbsd4" ] && [ -f "$gcc_makefile" ]; then
