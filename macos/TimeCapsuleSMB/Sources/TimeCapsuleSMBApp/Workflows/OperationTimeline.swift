...
enum OperationTimelineBuilder {
    ...
    private static let deployStageLocalizations: [String: OperationStageLocalization] = [
        ...
        "preflight_flash_capacity": .init(titleKey: "timeline.deploy.title.preflight_flash_capacity", detailKey: "timeline.deploy.detail.preflight_flash_capacity"),
        ...
        "upload_discovery": .init(titleKey: "timeline.deploy.title.upload_discovery", detailKey: "timeline.deploy.detail.upload_discovery"),
        ...
        "cleanup_legacy_flash_discovery": .init(titleKey: "timeline.deploy.title.cleanup_legacy_flash_discovery", detailKey: "timeline.deploy.detail.cleanup_legacy_flash_discovery"),
        "flush_legacy_flash_cleanup": .init(titleKey: "timeline.deploy.title.flush_legacy_flash_cleanup", detailKey: "timeline.deploy.detail.flush_legacy_flash_cleanup"),
