...
class ArtifactTests(unittest.TestCase):
    def test_load_artifact_manifest_contains_expected_records(self) -> None:
        ...
        self.assertIn("samba-dcerpcd", manifest)
        self.assertIn("rpcd_classic", manifest)
        self.assertIn("smbd-netbsd4le", manifest)
        self.assertIn("samba-dcerpcd-netbsd4le", manifest)
        self.assertIn("rpcd_classic-netbsd4le", manifest)
        self.assertIn("smbd-netbsd4be", manifest)
        self.assertIn("samba-dcerpcd-netbsd4be", manifest)
        self.assertIn("rpcd_classic-netbsd4be", manifest)
