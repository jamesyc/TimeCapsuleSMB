...
class ArtifactTests(unittest.TestCase):
    def test_load_artifact_manifest_contains_expected_records(self) -> None:
        ...
        self.assertIn("xattr-migrator", manifest)
        self.assertIn("xattr-migrator-netbsd4le", manifest)
        self.assertIn("xattr-migrator-netbsd4be", manifest)
        self.assertIn("discovery", manifest)
        self.assertIn("discovery-netbsd4le", manifest)
        self.assertIn("discovery-netbsd4be", manifest)
        ...
        self.assertIn("telemetry-netbsd4le", manifest)
        self.assertIn("telemetry-netbsd4be", manifest)
        ...
        self.assertNotIn("mdns", manifest)
        self.assertNotIn("nbns", manifest)
