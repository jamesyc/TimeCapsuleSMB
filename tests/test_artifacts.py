...
class ArtifactTests(unittest.TestCase):
    def test_load_artifact_manifest_contains_expected_records(self) -> None:
        ...
        self.assertIn("service-netbsd4le", manifest)
        self.assertIn("service-netbsd4be", manifest)
        self.assertNotIn("discovery", manifest)
        self.assertNotIn("discovery-netbsd4le", manifest)
        self.assertNotIn("discovery-netbsd4be", manifest)
